...
# Blue Mountain
Sub-Theme extension, which allows you to style the t3kit theme in backend without coding
...
* Make sure you're on the right version of **theme_t3kit_bluemountain**
